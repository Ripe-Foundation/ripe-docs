...
**Step 2.** Get USDG. It's the chain's native dollar; swap for it on a DEX or bring it across the bridge.
...
**Step 4.** This is the step people miss: come back to Ripe, go to the **Earn** page, find the GREEN/USDG LP row (marked Stability Pool) and press **Deposit**. LP tokens sitting in your wallet earn nothing; deposited ones earn RIPE.

![Depositing your LP tokens into Ripe](../.gitbook/assets/user-guide-11-lp-deposit-modal.png)

Once deposited, the card shows your position, the yield, and the RIPE rewards on top.
...
**Step 5.** Rewards accrue automatically and show on your dashboard. They're paid in RIPE, which means claiming them runs through the [claim dialog described in the next guide](06-get-and-lock-ripe.md#claiming-rewards-always-locks-something), and that dialog stakes and locks part of what you claim. Read that section before you claim for the first time.
